...
public class Question extends AppCompatActivity implements View.OnClickListener {
    ...
    private TextView tvtraloi1,tvtraloi2, tvtraloi3;
    ...
    private void setDataQuesion(AnswerAndQuestion question) {
        ...
        if(!question.answerList.get(2).getAnswer().isEmpty()){
            tvtraloi3.setVisibility(View.VISIBLE);
            tvtraloi3.setText(question.answerList.get(2).getAnswer());
        }
        else{tvtraloi3.setVisibility(View.INVISIBLE);}
    ...
    private void initUI(){
        ...
        tvtraloi3 = findViewById(R.id.tv_answer3);
