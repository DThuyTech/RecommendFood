...
public class Register extends AppCompatActivity {
    ...
    public void registerAccount() {
        ...
        User user = new User(true, edtTuoi.getText().toString(), userName.getText().toString(), userPass.getText().toString(), edtChieuCao.getText().toString(), edtCanNang.getText().toString());
